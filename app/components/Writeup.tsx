...
const Portfolio = () => {
  ...
  return (
    <section id='writeup' className='writeup-section'>
        <h2 data-aos="fade-down" data-aos-duration="1500">Mes Défis & Solutions </h2> 

        <p className='project-description' data-aos="fade-up" data-aos-duration="1500">
            Section où vous retrouverez tous les challenges réalisés pour mettre en pratique mes compétences en cybersécurité, réseaux et systèmes. Chaque projet est accompagné d'une description détaillée de la problématique, des étapes de résolution et des outils utilisés.
        </p>
